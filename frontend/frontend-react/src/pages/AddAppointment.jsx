...
const INITIAL = { nomClient: '', telephone: '', dateRendezVous: '', heureRendezVous: '', statut: 'EN_ATTENTE' };
...
export default function AddAppointment() {
  ...
  const handleSubmit = async (e) => {
    ...
    setApiError(null);
    try {
      const payload = { ...form, nomClient: form.nomClient.trim(), telephone: form.telephone.trim() };
      await rendezvousService.create(payload);
      showNotification(t('add.success'));
      ...
      if (detail?.details) {
        ...
        setApiError(detail?.error || t('add.error'));
      }
    } finally {
      setSubmitting(false);
    }
  ...
  return (
    <>
      <h1 className="h3 mb-4">{t('add.title')}</h1>
            ...
            <div className="row g-3">
              <div className="col-12 col-md-6">
                ...
                <input id="nomClient" name="nomClient"
                  ...
                  value={form.nomClient} onChange={handleChange} placeholder={t('form.nomClient.placeholder')} />
